...
import image1 from "../../assets/question-images/bab_2/image1.png";
...
export const bab2Questions = createQuestions("bab-2", [
  {
    ...
    correctAnswer: "B",
    explanation:
      "Ekosistem mencakup hubungan makhluk hidup dengan lingkungan biotik dan abiotiknya.",
  },
  {
    question:
      "Peristiwa makan dan dimakan dalam suatu ekosistem dengan urutan tertentu disebut ...",
    options: [
      "rantai makanan",
...
Pernyataan yang sesuai dengan rantai makanan di atas adalah ....`,
    options: [
      ...
      "Elang berperan sebagai konsumen IV",
      "Ular berperan sebagai trofik IV",
    ],
    correctAnswer: "C",
    explanation:
      "Berdasarkan kunci, elang berperan sebagai konsumen IV pada rantai makanan tersebut.",
    image: image1,
  },
  {
    ...
    correctAnswer: "A",
    explanation:
      "Aliran energi pada ekosistem kolam dimulai dari energi matahari, produsen, konsumen, lalu pengurai.",
  },
  {
    question:
      "Komponen rantai makanan kebun terdiri dari belalang, burung, rumput, dan ular. Perubahan yang terjadi jika burung punah adalah ....",
    options: [
      "rumput dan belalang berkembang pesat",
      "rumput berkurang dan ular punah",
      "belalang dan ular punah",
      "belalang dan ular berkembang pesat",
    ],
    correctAnswer: "D",
    explanation:
      "Berdasarkan kunci, punahnya burung menyebabkan belalang dan ular berkembang pesat.",
  },
  {
    question: "Pemakai bahan organik yang dihasilkan oleh produsen adalah ....",
    options: ["konsumen", "produsen", "pengurai", "produksi"],
    correctAnswer: "A",
    explanation:
      "Konsumen memperoleh energi dengan memakan produsen atau organisme lain.",
  },
  {
    question: "Contoh makhluk hidup pengurai adalah ...",
    options: ["lumut", "ganggang", "tumbuhan hijau", "bakteri dan jamur"],
    correctAnswer: "D",
    explanation:
      "Bakteri dan jamur menguraikan sisa makhluk hidup menjadi zat hara.",
  },
  {
    question:
      "Penghilangan komponen konsumen I pada suatu ekosistem kolam akan menyebabkan ....",
    options: [
      "Konsumen I darat menggantikan konsumen II kolam",
      "Status konsumen III merangkap sebagai herbivora",
      "Jumlah populasi produsen semakin banyak",
      "Konsumen II berubah fungsi menjadi konsumen I",
    ],
    correctAnswer: "C",
    explanation:
      "Jika konsumen I hilang, produsen lebih sedikit dimakan sehingga populasinya dapat meningkat.",
  },
  {
    question:
    ...
    options: [
      ...
      "peningkatan populasi kambing dan penurunan populasi harimau",
      "penurunan populasi kambing dan harimau",
    ],
    correctAnswer: "A",
    explanation:
      "Konsumen primer yang turun membuat rumput meningkat, lalu predator kekurangan makanan.",
  },
  {
    question:
    ...
    options: [
      ...
      "buaya, ular dan kadal",
      "harimau, hiu dan elang",
    ],
    correctAnswer: "D",
    explanation:
      "Harimau, hiu, dan elang adalah predator puncak pada banyak ekosistem.",
  },
  {
    question:
    ...
    correctAnswer: "B",
    explanation:
      "Produsen seperti fitoplankton menyimpan energi paling besar pada dasar piramida makanan.",
  },
  {
    question:
...
Aliran energi yang terjadi pada ekosistem kolam tersebut adalah ....`,
    ...
    correctAnswer: "B",
    explanation:
      "Urutan energi adalah fitoplankton, zooplankton, ikan kecil, ikan besar, lalu pengurai.",
  },
  {
    question:
  ...
  },
  {
    ...
    options: [
      ...
      "nutrisi atau zat hara dalam tanah",
      "hewan pemangsa yang lebih besar",
    ],
    correctAnswer: "C",
    explanation:
      "Pengurai mengembalikan zat hara ke tanah sehingga dapat dipakai tumbuhan.",
  },
  {
    question:
      "Tindakan manusia berikut yang dapat merusak ekosistem laut adalah ...",
    options: [
      "menangkap ikan dengan pancing",
      "meletakan bom untuk menangkap ikan besar",
      "menangkap ikan besar",
      "melestarikan terumbu karang",
    ],
    correctAnswer: "B",
    explanation: "Bom ikan merusak habitat laut dan membunuh banyak organisme.",
  },
  {
    question:
    ...
    options: [
      ...
      "menjaga mata air di daratan",
      "menjaga kesuburan tanah",
    ],
    correctAnswer: "A",
    explanation:
      "Terumbu karang membantu meredam gelombang dan melindungi pantai dari abrasi.",
  },
  {
    question:
...
Dampak dari penebangan hutan secara liar diantaranya ditunjukkan oleh nomor ...`,
  ...
  },
  {
    ...
    options: [
      ...
      "ekosistem sungai menjadi rusak",
      "kesuburan tanah sekitar sungai meningkat",
    ],
    correctAnswer: "C",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "kadar oksigen air meningkat",
      "ikan mendapatkan nutrisi",
    ],
    correctAnswer: "A",
    explanation: "Deterjen mengandung bahan kimia yang dapat mencemari air.",
  },
  {
    question:
  ...
  },
  {
    ...
    options: [
      ...
      "terjadi penambahan produsen",
      "adanya hubungan timbal balik antara organisme dengan lingkungannya",
    ],
    correctAnswer: "D",
    explanation:
      "Organisme bergantung pada interaksi dengan makhluk hidup lain dan lingkungannya.",
  },
]);
