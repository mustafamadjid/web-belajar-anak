...
Peristiwa pada gambar menunjukkan adanya ….`,
    options: [
      "pemantulan cahaya",
      "penguraian cahaya",
      "penyerapan cahaya",
...
Berdasarkan gambar, pembiasan terjadi bila cahaya datang dari ...`,
    options: [
      "udara menuju air",
      "udara menuju udara",
      "air menuju udara",
  ...
  {
    question: `Perhatikan gambar berikut!
Gambar di atas menunjukkan bahwa cahaya mempunyai sifat ….`,
    options: [
      "dapat dibiaskan",
      "menembus benda bening",
      "merambat lurus",
  ...
  {
    question: `Perhatikan gambar berikut!
Peristiwa terbentuknya pelangi menunjukkan sifat cahaya yaitu dapat diuraikan menjadi beberapa warna yaitu merah, kuning, hijau, biru, dan ungu. Cahaya-cahaya tersebut berasal dari ….`,
    options: [
  ...
  {
    question: `Perhatikan ciri-ciri bagian mata berikut ini:
(1) bagian berwarna hitam yang merupakan jalan masuknya cahaya ke dalam mata
...
Bagian mata yang dideskripsikan di atas adalah ….`,
  ...
  {
    question: `Perhatikan sifat-sifat bayangan berikut ini!
(1) nyata
(2) terbalik
(3) maya
(4) tegak
